...
function Card({ title, items }) {
    return (
        <div className="block max-w p-6 bg-inherit border border-[#7f69a5] rounded-2xl h-auto shadow-lg shadow-[#7f69a5]">
            <h2 className="mb-2 text-2xl font-bold tracking-tight text-center text-[#7f69a5]">{title}</h2>
